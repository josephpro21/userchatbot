...
class RChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Gamba na Adam"),
        ),
        body: Column(
          children: [
        ...
        child: foundData.rmessages.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final data = foundData
                      .rmessages[foundData.rmessages.length - 1 - index];
                  return Align(
                            ...
                            onLongPress: () {
                              showDialog(
                                  ...
                                  builder: (context) => AlertDialog(
                                        ...
                                        title: const Text('Sangura mesege'),
                                        ...
                                        actions: [
                                          TextButton(
                                              ...
                                              child: const Text("Shazamu")),
                                          TextButton(
                                            onPressed: () {
                                              Provider.of<RFetch>(context,
                                                      listen: false)
                                                  .deleteMessage(data);
                                              Navigator.pop(context);
